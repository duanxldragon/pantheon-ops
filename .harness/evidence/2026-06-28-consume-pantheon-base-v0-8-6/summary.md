...
- Follow-up hardening: `go test ./backend/internal/middleware` and `node --test tests/scripts/foundation-release/consume-foundation-release.test.mjs` passed after addressing CodeQL review findings on request logging and release-lock handling
