...
const jaJPFallback = {
  ...
  'app.appearance.dark': 'ダーク',
  'app.appearance.dark.description': '暗い環境でのまぶしさを抑える暗色サーフェス。',
  ...
  'common.moreFilters': 'フィルター',
  'common.clearFilters': 'フィルターをクリア',
  'common.searchKeyword.placeholder': 'キーワードで検索…',
  'common.expand': '展開',
  ...
  'common.total': '合計',
  'common.totalWithCount': '合計 {{count}} 件',
  ...
  'i18n.group': 'グループ',
  'i18n.key': 'I18n キー',
  'i18n.search.placeholder': '翻訳キーで検索…',
  'i18n.value': '内容',
  'i18n.remark': '備考',
  'i18n.createdAt': '作成日時',
  'i18n.updatedAt': '更新日時',
  ...
  'auth.security.timeRange': '時間範囲',
  'auth.security.timePreset.min5': '5分',
  'auth.security.timePreset.min30': '30分',
  'auth.security.timePreset.hour1': '1時間',
  'auth.security.timePreset.hour3': '3時間',
  'auth.security.timePreset.hour12': '12時間',
  'auth.security.timePreset.hour24': '24時間',
  'auth.security.timePreset.day2': '2日',
  'auth.security.timePreset.day7': '7日',
  'auth.security.timePreset.day30': '30日',
  'auth.security.timePreset.today': '今日',
  'auth.security.timePreset.yesterday': '昨日',
  'auth.security.timePreset.custom': 'カスタム',
  ...
  'auth.session.search.placeholder': 'ユーザー名または IP で検索…',
  ...
  'auth.loginLog.search.placeholder': 'ユーザー名・IP・ログイン地で検索…',
  ...
  'auth.securityEvent.search.placeholder': 'ユーザー名で検索…',
  ...
  'auth.login_log.time_preset.last_5_minutes': '直近5分',
  'auth.login_log.time_preset.last_30_minutes': '直近30分',
  'auth.login_log.time_preset.last_1_hour': '直近1時間',
  'auth.login_log.time_preset.last_3_hours': '直近3時間',
  'auth.login_log.time_preset.last_12_hours': '直近12時間',
  'auth.login_log.time_preset.last_24_hours': '直近24時間',
  'auth.login_log.time_preset.last_2_days': '直近2日',
  'auth.login_log.time_preset.last_7_days': '直近7日',
  'auth.login_log.time_preset.last_30_days': '直近30日',
  'auth.login_log.time_preset.today': '今日',
  'auth.login_log.time_preset.yesterday': '昨日',
  'auth.login_log.time_range.start': '開始時刻',
  'auth.login_log.time_range.to': 'から',
  'auth.login_log.time_range.end': '終了時刻',
  'auth.login_log.time_range.label': '時間範囲',
  'auth.login_log.time_range.custom': 'カスタム',
  ...
  'system.user.search.placeholder': 'ユーザー名・ニックネーム・メールで検索…',
  ...
  'system.role.search.placeholder': 'ロール名またはキーで検索…',
  ...
  'system.role.importSuccess': 'インポート完了：{{created}} 件追加、{{updated}} 件更新',
  'system.role.importFailed': 'インポートに失敗しました。ファイル形式を確認してください。',
  ...
  'system.permission.search.placeholder': 'ロールキーまたは API パスで検索…',
  ...
  'system.menu.search.placeholder': 'メニュータイトルキーまたはパスで検索…',
  'system.menu.path': 'パス',
  ...
  'system.dept.search.placeholder': '部門名で検索…',
  ...
  'system.dept.task.scope.dept': '部門',
  'system.dept.task.scope.post': '役職',
  'system.dept.task.tag': 'ガバナンス課題',
  'system.dept.task.tag.clean': '健全',
  'system.dept.task.tag.leaderless': '責任者不在',
  'system.dept.task.tag.no-post': '役職なし',
  'system.dept.task.tag.empty': '空部門',
  'system.dept.task.tag.in-use': 'メンバー割当中',
  'system.dept.task.tag.disabled': '無効',
  'system.dept.task.tag.root': '組織ルート',
  'system.dept.task.resource': 'リソース',
  'system.dept.task.blockedBy': '阻害要因',
  'system.dept.task.blockedBy.none': '阻害なし',
  'system.dept.task.blockedBy.children': '下位部門',
  'system.dept.task.blockedBy.posts': '下位役職',
  'system.dept.task.blockedBy.users': '使用者',
  'system.dept.task.action': '推奨アクション',
  'system.dept.task.action.keep-observing': '継続観察',
  'system.dept.task.action.assign-leader': '責任者割当',
  'system.dept.task.action.create-post': '役職作成',
  'system.dept.task.action.review-merge-or-delete': '統合/削除を検討',
  'system.dept.task.action.clear-child-depts': '下位部門を整理',
  'system.dept.task.action.clear-posts': '役職を整理',
  'system.dept.task.action.clear-users': 'メンバーを整理',
  'system.dept.task.action.reassign-users': 'メンバーを再配置',
  'system.dept.task.action.review-status': '有効状態を見直し',
  'system.dept.task.action.delete-or-keep-disabled': '削除または無効で保持',
  ...
  'system.post.search.placeholder': '職位コードまたは名称で検索…',
  ...
  'system.post.governance.tag.clean': '健全',
  'system.post.governance.tag.in-use': 'メンバー割当中',
  'system.post.governance.tag.disabled': '無効',
  'system.post.governance.blockedBy.none': '阻害なし',
  'system.post.governance.blockedBy.users': '使用者',
  'system.post.governance.action.reassign-users': 'メンバーを再配置',
  'system.post.governance.action.review-status': '有効状態を見直し',
  'system.post.governance.action.delete-or-keep-disabled': '削除または無効で保持',
  'system.audit.subtitle': 'プラットフォームの重要操作記録と変更監査を全体で確認します。',
  'system.audit.title': '操作タイトル',
  'system.audit.search.placeholder': 'タイトル・操作者・リクエスト ID で検索…',
  ...
  'generator.wizard.relationFromField': '参照元フィールド',
  'generator.wizard.relationToField': '参照先フィールド',
