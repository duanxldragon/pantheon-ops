...
const koKRFallback = {
  ...
  'common.all': '전체',
  'common.filters': '필터',
  'common.moreFilters': '필터',
  'common.clearFilters': '필터 지우기',
  'common.searchKeyword.placeholder': '키워드로 검색…',
  'common.expand': '펼치기',
  'common.collapse': '접기',
  ...
  'common.total': '합계',
  'common.totalWithCount': '총 {{count}}개',
  ...
  'i18n.group': '그룹',
  'i18n.key': 'I18n 키',
  'i18n.search.placeholder': '번역 키로 검색…',
  'i18n.value': '내용',
  'i18n.remark': '비고',
  ...
  'auth.security.timeRange': '시간 범위',
  'auth.security.timePreset.min5': '5분',
  'auth.security.timePreset.min30': '30분',
  'auth.security.timePreset.hour1': '1시간',
  'auth.security.timePreset.hour3': '3시간',
  'auth.security.timePreset.hour12': '12시간',
  'auth.security.timePreset.hour24': '24시간',
  'auth.security.timePreset.day2': '2일',
  'auth.security.timePreset.day7': '7일',
  'auth.security.timePreset.day30': '30일',
  'auth.security.timePreset.today': '오늘',
  'auth.security.timePreset.yesterday': '어제',
  'auth.security.timePreset.custom': '사용자 지정',
  ...
  'auth.session.search.placeholder': '사용자명 또는 IP로 검색…',
  ...
  'auth.loginLog.search.placeholder': '사용자명·IP·위치로 검색…',
  ...
  'auth.securityEvent.search.placeholder': '사용자명으로 검색…',
  ...
  'auth.login_log.time_preset.last_5_minutes': '최근 5분',
  'auth.login_log.time_preset.last_30_minutes': '최근 30분',
  'auth.login_log.time_preset.last_1_hour': '최근 1시간',
  'auth.login_log.time_preset.last_3_hours': '최근 3시간',
  'auth.login_log.time_preset.last_12_hours': '최근 12시간',
  'auth.login_log.time_preset.last_24_hours': '최근 24시간',
  'auth.login_log.time_preset.last_2_days': '최근 2일',
  'auth.login_log.time_preset.last_7_days': '최근 7일',
  'auth.login_log.time_preset.last_30_days': '최근 30일',
  'auth.login_log.time_preset.today': '오늘',
  'auth.login_log.time_preset.yesterday': '어제',
  'auth.login_log.time_range.start': '시작 시간',
  'auth.login_log.time_range.to': '부터',
  'auth.login_log.time_range.end': '종료 시간',
  'auth.login_log.time_range.label': '시간 범위',
  'auth.login_log.time_range.custom': '사용자 지정',
  ...
  'system.user.search.placeholder': '사용자명·닉네임·이메일로 검색…',
  ...
  'system.role.search.placeholder': '역할 이름 또는 키로 검색…',
  ...
  'system.role.members': '역할 멤버',
  'system.role.members.subtitle': '역할 화면에서 멤버 바인딩을 직접 관리',
  'system.role.members.hint':
    '사용자 생성 시 역할을 비워 둘 수 있으며, 이후 이 화면에서 일괄 할당하거나 제거할 수 있습니다.',
  'system.role.members.candidatePlaceholder': '이 역할에 추가할 사용자를 검색하고 선택하세요',
  'system.role.members.candidateEmpty': '추가할 수 있는 멤버가 없습니다',
  'system.role.members.searchPlaceholder': '현재 멤버를 사용자명 또는 닉네임으로 검색',
  'system.role.members.filterStatus': '멤버 상태 필터',
  'system.role.members.addSuccess': '{{count}}명의 멤버를 추가했습니다',
  'system.role.members.removeSuccess': '{{count}}명의 멤버를 제거했습니다',
  'system.role.members.removeConfirm': '이 멤버의 현재 역할 바인딩을 제거하시겠습니까?',
  'system.role.members.empty': '이 역할에 바인딩된 멤버가 없습니다',
  ...
  'system.role.importSuccess': '가져오기 완료: {{created}}개 추가, {{updated}}개 업데이트',
  'system.role.importFailed': '가져오기에 실패했습니다. 파일 형식을 확인하세요.',
  ...
  'system.permission.search.placeholder': '역할 키 또는 API 경로로 검색…',
  ...
  'system.dept.search.placeholder': '부서 이름으로 검색…',
  ...
  'system.dept.task.scope.dept': '부서',
  'system.dept.task.scope.post': '직책',
  'system.dept.task.tag': '거버넌스 이슈',
  'system.dept.task.tag.clean': '정상',
  'system.dept.task.tag.leaderless': '책임자 부재',
  'system.dept.task.tag.no-post': '직책 없음',
  'system.dept.task.tag.empty': '빈 부서',
  'system.dept.task.tag.in-use': '구성원 사용 중',
  'system.dept.task.tag.disabled': '비활성',
  'system.dept.task.tag.root': '조직 루트',
  'system.dept.task.resource': '리소스',
  'system.dept.task.blockedBy': '차단 요인',
  'system.dept.task.blockedBy.none': '차단 없음',
  'system.dept.task.blockedBy.children': '하위 부서',
  'system.dept.task.blockedBy.posts': '하위 직책',
  'system.dept.task.blockedBy.users': '사용자',
  'system.dept.task.action': '권장 작업',
  'system.dept.task.action.keep-observing': '계속 관찰',
  'system.dept.task.action.assign-leader': '책임자 지정',
  'system.dept.task.action.create-post': '직책 생성',
  'system.dept.task.action.review-merge-or-delete': '통합 또는 삭제 검토',
  'system.dept.task.action.clear-child-depts': '하위 부서 정리',
  'system.dept.task.action.clear-posts': '직책 정리',
  'system.dept.task.action.clear-users': '구성원 정리',
  'system.dept.task.action.reassign-users': '구성원 재배치',
  'system.dept.task.action.review-status': '활성 상태 검토',
  'system.dept.task.action.delete-or-keep-disabled': '삭제 또는 비활성 유지',
  ...
  'system.post.search.placeholder': '직위 코드 또는 이름으로 검색…',
  ...
  'system.post.governance.tag.clean': '정상',
  'system.post.governance.tag.in-use': '구성원 사용 중',
  'system.post.governance.tag.disabled': '비활성',
  'system.post.governance.blockedBy.none': '차단 없음',
  'system.post.governance.blockedBy.users': '사용자',
  'system.post.governance.action.reassign-users': '구성원 재배치',
  'system.post.governance.action.review-status': '활성 상태 검토',
  'system.post.governance.action.delete-or-keep-disabled': '삭제 또는 비활성 유지',
  'system.audit.subtitle': '플랫폼의 전체 핵심 작업 기록과 변경 감사를 확인합니다.',
  'system.audit.title': '작업 제목',
  'system.audit.search.placeholder': '제목·작업자·요청 ID로 검색…',
  ...
  'generator.moduleManager.verifiedAt': '검증 시간',
  ...
  'generator.wizard.relationFromField': '원본 필드',
  'generator.wizard.relationToField': '대상 필드',
