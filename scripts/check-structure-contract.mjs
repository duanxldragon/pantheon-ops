 ...
 * Contract source: pantheon-base docs/designs/REPOSITORY_LAYOUT.md §2
 * (placement rules) plus the module-domain taxonomy in DESIGN.md §2.
 * Vendored from pantheon-base scripts/harness/check-structure-contract.mjs.
 *
...
function printHelp() {
  console.log('Usage: node scripts/check-structure-contract.mjs [--json] [--strict] [--root <path>]');
