...
const OUT_OF_SCOPE_PATTERNS = [
  ...
  /\bnot in this pr\b/i,
  /\bpre[- ]existing\b/i,
  /\bpre[- ]existing codeql\b/i,
  /\bpre[- ]existing baseline\b/i,
  /\bnot introduced in this pr\b/i,
  /\bnot new in this pr\b/i,
  /\bnot introduced by this\b/i,
  /\balready present in (main|default|master) branch\b/i,
  /\b既有 baseline\b/i,
  /\b既有基线\b/i,
  /\b误报\b/i,
  /\bfalse positive\b/i,
  /\bcodeql alert.*already (acknowledged|noted|filed|tracked)\b/i,
  /\bcodeql.*(pre[- ]existing|not new|baseline)\b/i,
];
