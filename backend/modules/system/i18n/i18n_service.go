...
var canonicalMenuLocaleEntries = map[i18nLocaleKey]i18nCanonicalEntry{
	...
	{Locale: "en-US", Key: "system.menu.access"}:        {Module: "system.iam", Group: "menu", Value: "Access Control"},
	{Locale: "ja-JP", Key: "system.menu.access"}:        {Module: "system.iam", Group: "menu", Value: "アクセス制御"},
	{Locale: "ko-KR", Key: "system.menu.access"}:        {Module: "system.iam", Group: "menu", Value: "접근 제어"},
	{Locale: "fr-FR", Key: "system.menu.access"}:        {Module: "system.iam", Group: "menu", Value: "Contrôle d'accès"},
	{Locale: "zh-CN", Key: "system.menu.org"}:           {Module: "system.org", Group: "menu", Value: "组织架构"},
	{Locale: "en-US", Key: "system.menu.org"}:           {Module: "system.org", Group: "menu", Value: "Organization"},
	{Locale: "ja-JP", Key: "system.menu.org"}:           {Module: "system.org", Group: "menu", Value: "組織管理"},
	{Locale: "ko-KR", Key: "system.menu.org"}:           {Module: "system.org", Group: "menu", Value: "조직 관리"},
	...
	{Locale: "en-US", Key: "system.menu.config"}:        {Module: "system.config", Group: "menu", Value: "Platform Config"},
	{Locale: "ja-JP", Key: "system.menu.config"}:        {Module: "system.config", Group: "menu", Value: "プラットフォーム設定"},
	{Locale: "ko-KR", Key: "system.menu.config"}:        {Module: "system.config", Group: "menu", Value: "플랫폼 설정"},
	{Locale: "fr-FR", Key: "system.menu.config"}:        {Module: "system.config", Group: "menu", Value: "Configuration de la plateforme"},
	...
	{Locale: "ja-JP", Key: "system.menu.security"}:      {Module: "system.auth", Group: "menu", Value: "セキュリティ監査"},
	{Locale: "ko-KR", Key: "system.menu.security"}:      {Module: "system.auth", Group: "menu", Value: "보안 감사"},
	{Locale: "fr-FR", Key: "system.menu.security"}:      {Module: "system.auth", Group: "menu", Value: "Audit de sécurité"},
	{Locale: "zh-CN", Key: "system.menu.user"}:          {Module: "system.iam", Group: "menu", Value: "用户管理"},
	{Locale: "en-US", Key: "system.menu.user"}:          {Module: "system.iam", Group: "menu", Value: "User Management"},
	{Locale: "ja-JP", Key: "system.menu.user"}:          {Module: "system.iam", Group: "menu", Value: "ユーザー管理"},
	{Locale: "ko-KR", Key: "system.menu.user"}:          {Module: "system.iam", Group: "menu", Value: "사용자 관리"},
	{Locale: "fr-FR", Key: "system.menu.user"}:          {Module: "system.iam", Group: "menu", Value: "Gestion des utilisateurs"},
	{Locale: "zh-CN", Key: "system.menu.role"}:          {Module: "system.iam", Group: "menu", Value: "角色管理"},
	{Locale: "en-US", Key: "system.menu.role"}:          {Module: "system.iam", Group: "menu", Value: "Role Management"},
	{Locale: "ja-JP", Key: "system.menu.role"}:          {Module: "system.iam", Group: "menu", Value: "ロール管理"},
	{Locale: "ko-KR", Key: "system.menu.role"}:          {Module: "system.iam", Group: "menu", Value: "역할 관리"},
	{Locale: "fr-FR", Key: "system.menu.role"}:          {Module: "system.iam", Group: "menu", Value: "Gestion des rôles"},
	{Locale: "zh-CN", Key: "system.menu.permission"}:    {Module: "system.iam", Group: "menu", Value: "权限管理"},
	{Locale: "en-US", Key: "system.menu.permission"}:    {Module: "system.iam", Group: "menu", Value: "Permission Management"},
	{Locale: "ja-JP", Key: "system.menu.permission"}:    {Module: "system.iam", Group: "menu", Value: "権限管理"},
	{Locale: "ko-KR", Key: "system.menu.permission"}:    {Module: "system.iam", Group: "menu", Value: "권한 관리"},
	{Locale: "fr-FR", Key: "system.menu.permission"}:    {Module: "system.iam", Group: "menu", Value: "Gestion des permissions"},
	{Locale: "zh-CN", Key: "system.menu.menu"}:          {Module: "system.iam", Group: "menu", Value: "菜单管理"},
	{Locale: "en-US", Key: "system.menu.menu"}:          {Module: "system.iam", Group: "menu", Value: "Menu Management"},
	{Locale: "ja-JP", Key: "system.menu.menu"}:          {Module: "system.iam", Group: "menu", Value: "メニュー管理"},
	{Locale: "ko-KR", Key: "system.menu.menu"}:          {Module: "system.iam", Group: "menu", Value: "메뉴 관리"},
	...
	{Locale: "en-US", Key: "system.menu.dept"}:          {Module: "system.org", Group: "menu", Value: "Department Management"},
	{Locale: "ja-JP", Key: "system.menu.dept"}:          {Module: "system.org", Group: "menu", Value: "部門管理"},
	{Locale: "ko-KR", Key: "system.menu.dept"}:          {Module: "system.org", Group: "menu", Value: "부서 관리"},
	{Locale: "fr-FR", Key: "system.menu.dept"}:          {Module: "system.org", Group: "menu", Value: "Gestion des départements"},
	{Locale: "zh-CN", Key: "system.menu.post"}:          {Module: "system.org", Group: "menu", Value: "岗位管理"},
	{Locale: "en-US", Key: "system.menu.post"}:          {Module: "system.org", Group: "menu", Value: "Post Management"},
	{Locale: "ja-JP", Key: "system.menu.post"}:          {Module: "system.org", Group: "menu", Value: "役職管理"},
	{Locale: "ko-KR", Key: "system.menu.post"}:          {Module: "system.org", Group: "menu", Value: "직책 관리"},
	{Locale: "fr-FR", Key: "system.menu.post"}:          {Module: "system.org", Group: "menu", Value: "Gestion des postes"},
	{Locale: "zh-CN", Key: "system.menu.dict"}:          {Module: "system.config", Group: "menu", Value: "字典管理"},
	{Locale: "en-US", Key: "system.menu.dict"}:          {Module: "system.config", Group: "menu", Value: "Dictionary Management"},
	{Locale: "ja-JP", Key: "system.menu.dict"}:          {Module: "system.config", Group: "menu", Value: "辞書管理"},
	{Locale: "ko-KR", Key: "system.menu.dict"}:          {Module: "system.config", Group: "menu", Value: "사전 관리"},
	{Locale: "fr-FR", Key: "system.menu.dict"}:          {Module: "system.config", Group: "menu", Value: "Gestion du dictionnaire"},
	{Locale: "zh-CN", Key: "system.menu.setting"}:       {Module: "system.config", Group: "menu", Value: "系统设置"},
	{Locale: "en-US", Key: "system.menu.setting"}:       {Module: "system.config", Group: "menu", Value: "System Settings"},
	...
	{Locale: "en-US", Key: "system.menu.i18n"}:          {Module: "system.config", Group: "menu", Value: "I18n Management"},
	...
	{Locale: "zh-CN", Key: "system.menu.modules"}:       {Module: "system.config", Group: "menu", Value: "模块管理"},
	{Locale: "en-US", Key: "system.menu.modules"}:       {Module: "system.config", Group: "menu", Value: "Module Manager"},
	{Locale: "ja-JP", Key: "system.menu.modules"}:       {Module: "system.config", Group: "menu", Value: "モジュール管理"},
	{Locale: "ko-KR", Key: "system.menu.modules"}:       {Module: "system.config", Group: "menu", Value: "모듈 관리"},
	{Locale: "fr-FR", Key: "system.menu.modules"}:       {Module: "system.config", Group: "menu", Value: "Gestion des modules"},
	{Locale: "zh-CN", Key: "system.menu.generator"}:     {Module: "system.config", Group: "menu", Value: "模块生成器"},
	{Locale: "en-US", Key: "system.menu.generator"}:     {Module: "system.config", Group: "menu", Value: "Module Generator"},
	{Locale: "ja-JP", Key: "system.menu.generator"}:     {Module: "system.config", Group: "menu", Value: "モジュール生成器"},
	{Locale: "ko-KR", Key: "system.menu.generator"}:     {Module: "system.config", Group: "menu", Value: "모듈 생성기"},
	{Locale: "fr-FR", Key: "system.menu.generator"}:     {Module: "system.config", Group: "menu", Value: "Générateur de modules"},
	...
	{Locale: "en-US", Key: "system.menu.session"}:       {Module: "system.auth", Group: "menu", Value: "Session Management"},
	{Locale: "ja-JP", Key: "system.menu.session"}:       {Module: "system.auth", Group: "menu", Value: "セッション管理"},
	{Locale: "ko-KR", Key: "system.menu.session"}:       {Module: "system.auth", Group: "menu", Value: "세션 관리"},
	{Locale: "fr-FR", Key: "system.menu.session"}:       {Module: "system.auth", Group: "menu", Value: "Gestion des sessions"},
