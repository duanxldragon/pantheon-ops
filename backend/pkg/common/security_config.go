...
func InitSecurityConfig() error {
	...
	AccessTokenSecret = []byte(ResolveSecret("PANTHEON_ACCESS_TOKEN_SECRET", DefaultDevSecrets.AccessToken))
	RefreshTokenSecret = []byte(ResolveSecret("PANTHEON_REFRESH_TOKEN_SECRET", DefaultDevSecrets.RefreshToken))
	OperationTokenSecret = []byte(ResolveSecret("PANTHEON_OP_TOKEN_SECRET", DefaultDevSecrets.OperationToken))
	return nil
}
